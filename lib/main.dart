...
import 'package:gp_106_flutter_project/screens/contact_us/my_contact_us_requests.dart';
...
import 'package:gp_106_flutter_project/screens/contact_us/create_contact_us_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        ScreenKeys.createContactUs: (context) => const CreateContactUsScreen(),
        ...
        ScreenKeys.myContactUsRequests: (context) =>  MyContactUsRequests(),
        // ScreenKeys.serviceRulePrice: (context) =>  ServiceRulePriceScreen(),
      },
    );
  }
}