...
class AddExperiencesScreen extends StatefulWidget {
    const AddExperiencesScreen({super.key});

  @override
  State<AddExperiencesScreen> createState() => _AddExperiencesScreenState();
}

class _AddExperiencesScreenState extends State<AddExperiencesScreen> {
      ...
      child: Scaffold(
          ...
          body: ListView(
            ...
            children:[
              ...
              Text('  Enter experience name',style: TextStyle(color: Colors.grey),),
              const SizedBox(height: 5,),
              AppTextFiled(controller: _emailController, hint: 'experience name',errorText: _emailErrors, icon: Icons.cast_for_education),
              ...
              ElevatedButton(
                ...
                ), child: const  Text('Add experience',style: TextStyle(fontSize: 20),),
              ),
